...
function Header() {
  return (
    <section className="bg-gray-700 select-none text-gray-200 ">
      <ul>
        <Link href="/">
          <a className="focus:text-red-500">
            <li className="hover:text-white focus:text-red-500">
        ...
        <li className="hover:text-white active:text-red-500">
