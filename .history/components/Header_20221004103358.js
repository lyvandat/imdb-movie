...
function Header() {
  return (
    <section className="flex flex-col p-5 items-center sm:flex-row sm:justify-center bg-gray-700 select-none text-gray-200 ">
      <ul className="flex space-x-5 mb-5 sm:mb-0 items-center">
